...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    if(!this.props.ioBrewUser.attributes.username) {
      ...
      links.push(<li key="UserDash"><a href="#">User Dash</a></li>);
      userDropdown = (
        <ul className="nav navbar-nav navbar-right">
          <li className="dropdown">
            <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{this.props.ioBrewUser.attributes.username} <span className="caret"></span></a>
      ...
      <nav className="navbar navbar-default">
        <div className="container-fluid">
          <div className="navbar-header">
            ...
            <a className="navbar-brand" href="#">Cheers {this.props.ioBrewUser.attributes.givenName} !</a>
          </div>
